...
function dados() {
	...
	$labels = array(
		'name'                       => _x( 'Dados', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Dados', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Dados', 'text_domain' ),
...
add_action( 'init', 'dados', 0 );
function Projetos() {

	$labels = array(
		'name'                       => _x( 'Projetos', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Projetos', 'Taxonomy Singular Name', 'text_domain' ),
